...
+(function ($) {
  ...
  ControlSidebar.prototype.expand = function () {
    ...
    if (!this.options.controlsidebarSlide) {
      $('body').addClass(ClassName.transition).addClass(ClassName.open).delay(50)
        .queue(function () {
  ...
  ControlSidebar.prototype.collapse = function () {
    if (!this.options.controlsidebarSlide) {
      $('body').addClass(ClassName.transition).removeClass(ClassName.open).delay(50)
        .queue(function () {
          $('body').removeClass(ClassName.transition);
          $(this).dequeue();
        });
...
+(function ($) {
  ...
  Tree.prototype.expand = function (tree, parent) {
    ...
    tree.stop().slideDown(this.options.animationSpeed, () => {
      $(this.element).trigger(expandedEvent);
      parent.height('auto');
    });
  };
  ...
  Tree.prototype.collapse = function (tree, parentLi) {
    ...
    tree.stop().slideUp(this.options.animationSpeed, () => {
